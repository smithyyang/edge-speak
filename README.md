...
A lightweight CLI text-to-speech tool powered by [edge-tts](https://github.com/rany2/edge-tts).
...
- `ffmpeg` (for dialogue mode audio concatenation)
...
### Dialogue (auto male/female voices)
```bash
